                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting header_menu" onclick="sortTable(this, 'sub_comment')">Comment</th>
                                <th class="sorting header_menu" onclick="sortTable(this, 'sub_type')">Type</th>
                                <th class="sorting header_menu" onclick="sortTable(this, 'sub_status')">Status</th>
                        ...
                        <tbody>
                            ...
                            foreach ($list_res as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'admin/Setting/manage_subscription/' . $row->sub_id; ?>" class="btn btn-info yellow" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil mr-0" aria-hidden="true"></i></a>
                                        <!--<a href="javascript:show_popup('<?php echo $row->sub_id ?>','<?php echo $cur_page ?>','Active');"  class="btn  btn-info red" data-original-title="" style="background-color: red;" data-toggle="tooltip" title="Delete"><i class="fa fa-close mr-0" aria-hidden="true"></i></a>-->
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
