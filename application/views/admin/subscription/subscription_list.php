...
<main class="app-content">
    <div class="app-title" style="margin:-30px 0px 30px">
        <div>
            <h1><i class="app-menu__icon fa fa-cog cust-fa-1x font-size14" style="font-size:20px !important;"></i>&nbsp;&nbsp;<?php echo $page_title ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile orderlistheader" style="justify-content:center;">
                <div class="col-sm-6 pl-0">
                    <div class="form-group">Search
                        <input class="app-search__input form-control" style="border: 2px solid #ced4da; border-radius: 4px;margin-right: 6px;" type="text" placeholder="Search by Subscription Name/Type" id="search_keyword" name="search_keyword">
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span class="">Delete Subscription</span></h4>
...
<script src="<?php echo base_url() . VALIDATIONS_FOLDER_PATH . 'subscription_pagi.js'; ?>"></script>
<script>
