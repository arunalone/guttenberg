...
<main class="app-content">
    <div class="app-title" style="margin:-30px 0px 30px">
        <div>
            <h1><i class="icon fa fa-cog" style="font-size:20px !important;"></i>&nbsp;&nbsp;<?php echo $page_title ?></h1>
        </div>
        <a class="btn btn-info btn-addon" style="float: right;padding-right: 10px" href="<?php echo base_url() . 'admin/Setting/manage_setting' ?>"><i class="fa fa-plus" aria-hidden="true" style="font-size:19px"></i> Add</a>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile orderlistheader" style="justify-content:center;">
                <div class="col-sm-6 pl-0">
                    <div class="form-group">Search
                        <input class="app-search__input form-control" style="border: 2px solid #ced4da; border-radius: 4px;margin-right: 6px;" type="text" placeholder="Search by Setting Name" id="search_keyword" name="search_keyword">
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><span class="">Delete Social Media</span></h4>
    ...
    <input type='hidden' id='colname' value="<?php echo isset($colname) ? $colname : "media"; ?>">
...
<script src="<?php echo base_url() . VALIDATIONS_FOLDER_PATH . 'setting_pagi.js'; ?>"></script>
<script>
