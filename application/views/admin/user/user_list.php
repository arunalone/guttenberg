            ...
            <div class="tile orderlistheader" style="justify-content:center;">
                <div class="col-sm-6 pl-0">
                    <div class="form-group">Search
                        <input class="app-search__input form-control" style="border: 2px solid #ced4da; border-radius: 4px;margin-right: 6px;" type="search" placeholder="Search by Customer Name/No of Booking/Email" id="search_val" name="search_val">
                    </div>
                </div>
