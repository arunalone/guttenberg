                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting header_menu" onclick="sortTable(this, 'coupon_count')">No of Coupons</th>
                                <th class="sorting header_menu" onclick="sortTable(this, 'address')">Address</th>
                        ...
                        <tbody>
                            ...
                            foreach ($list_res as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="number_field"><?php echo $row->coupon_count ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo base_url() . 'admin/User/customer_detail/' . $row->user_id; ?>" class="btn btn-info green-dark" data-toggle="tooltip" title="View"><i class="fa fa-eye mr-0" aria-hidden="true"></i></a>
                                        <a href="javascript:show_cust_popup('<?php echo $row->user_id; ?>');"  class="btn  btn-gray red" data-original-title="" style="background-color: red;" data-toggle="tooltip" title="Delete"><i class="fa fa-close  mr-0" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
