                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                ...
                                <th class="sorting header_menu" onclick="sortTable(this, 'email')">Email ID</th>
                                <th class="sorting header_menu" onclick="sortTable(this, 'city_name')">City</th>
                                <th class="sorting header_menu" onclick="sortTable(this, 'state_name')">State</th>
                                <th class="sorting header_menu number_field" onclick="sortTable(this, 'store_coupons')">Active # of Coupons</th>
                        ...
                        <tbody>
                            ...
                            foreach ($list_res as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="number_field"><?php echo $row->store_coupons; ?></td>
                                    <td><?php echo $row->status; ?></td>
                                    <td>
                                        <a href="<?php echo base_url() . 'admin/Store/manage_store/' . $row->store_id; ?>" class="btn btn-info yellow" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil mr-0" aria-hidden="true"></i></a>
                                        <a href="javascript:show_popup('<?php echo $row->store_id ?>','<?php echo $cur_page ?>','Yes');"  class="btn  btn-info red" data-original-title="" style="background-color: red;" data-toggle="tooltip" title="Delete"><i class="fa fa-close mr-0" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
