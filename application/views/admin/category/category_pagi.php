            ...
            <div class="tile-body">
                ...
                <?php if (!empty($list_res)) { ?>
                    <table class="table table-hover table-bordered" id="sampleTable">
                        <thead>
                            <tr>
                                <th class="sorting header_menu" onclick="sortTable(this, 'category_name')">Category Name</th>
                        ...
                        <tbody>
                            ...
                            foreach ($list_res as $key => $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'admin/Category/manage_category/' . $row->category_id; ?>" class="btn btn-info yellow" data-toggle="tooltip" title="Edit"><i class="fa fa-pencil mr-0" aria-hidden="true"></i></a>
                                        <a href="javascript:show_popup('<?php echo $row->category_id ?>','<?php echo $cur_page ?>','Yes');" data-toggle="tooltip" title="Delete" class="btn  btn-info red" data-original-title="" style="background-color: red;"><i class="fa fa-close mr-0" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
