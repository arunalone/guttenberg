...
<main class="app-content">
    <div class="app-title" style="margin:-30px 0px 30px">
        <div>
            <h1><i class="app-menu__icon fa fa-clone cust-fa-1x"></i>&nbsp;&nbsp;<?php echo $page_title ?></h1>
        </div>
        <?php if ($this->session->userdata('user_role') == "admin") { ?>
            <a class="btn btn-info btn-addon" style="float: right;padding-right: 10px" href="<?php echo base_url() . 'admin/Coupon/manage_coupon' ?>"><i class="fa fa-plus" aria-hidden="true" style="font-size:19px"></i> Add</a>
        <?php } ?>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile orderlistheader" style="align-items:center; justify-content:center;">
                <div class="col-sm-3 pl-0">
                    <div class="form-group">Search
                        <input class="app-search__input form-control" style="border: 2px solid #ced4da; border-radius: 4px;margin-right: 6px;" type="text" placeholder="Search by Coupon Name" id="search_keyword" name="search_keyword">
                    </div>
                </div>
...
<script src="<?php echo base_url() . VALIDATIONS_FOLDER_PATH . 'coupon_pagi.js'; ?>"></script>
