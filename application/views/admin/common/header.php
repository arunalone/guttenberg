...
<body class="app sidebar-mini">
    ...
    <?php if ($this->session->userdata('is_user_logged_in') > 0) { ?>
        <header class="app-header"><a class="app-header__logo" href="<?php echo base_url() . 'admin/user' ?>" style="padding-top: 7px;"><img src="<?php echo base_url() . DEFAULT_PLACEHOLDER_USER_IMAGE ?>" ></a>
            ...
            <ul class="app-nav">
                <!-- User Menu-->
                <li class="dropdown"><a class="app-nav__item" href="<?php echo base_url() . 'admin/user/profile/' . $this->session->userdata('user_id') ?>" data-toggle="dropdown" aria-label="Open Profile Menu" aria-expanded="false"><?php echo $this->session->userdata('full_name') ?><i class="fa fa-user fa-lg" style="margin-left: 6px;"></i><i class="fa fa-down"></i></a>
