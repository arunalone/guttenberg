...
if (!empty($row)) {
    ...
    $status = $role_id = $role_name = $comment = "";
}
?>
...
<main class="app-content">
    <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb side">
            ...
            <li class="breadcrumb-item active"><a href="<?php echo base_url() . 'admin/setting/role' ?>">Role</a></li>
        </ul>
    </div>
                                ...
                                <div class="col" style="padding-right:0px;">
                                    <div class="form-check" style="display:inline-block">
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="status" type="radio"  value="ACTIVE" checked="" >Active
                                        </label>
                                    </div>
                                    <div class="form-check" style="display:inline-block">
                                        <label class="form-check-label">
                    ...
                    <div class="col">
                        <div class="tile-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control inputfield" type="text" placeholder="Comment"  id="comment" name="comment" value="<?php echo $comment ?>">
                                </div>
                            </div>
